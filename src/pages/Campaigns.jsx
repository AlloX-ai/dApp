...
import wodHodl from '../assets/wodHodl.png';
import { WODCampaignPage } from "./WodCampaignPage";
...
export function CampaignsPage() {
  ...
  return (
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="p-8">
            ...
            <p className="text-gray-600 mb-6">
              Buy WOD tokens, hold until snapshot, and earn tiered Gem rewards with multipliers
            </p>
    ...
    <button
      ...
      {/* Content */}
      {activeTab === "trading" ? <TradingCompetitionPage /> : activeTab === "season1" ? <Season1 /> : <WODCampaignPage />}
    </div>
    }
    </>
