...
const JOURNEY_INFO = [
    ...
    },
    {
        ...
        answer:
            "Diversified combines multiple narratives in one basket (DeFi, Layer 2, Privacy, Infrastructure, SocialFi, Payments, AI, Gaming, and DePIN). If you choose a single narrative, token selection focuses more heavily on that theme.",
    },
    {
