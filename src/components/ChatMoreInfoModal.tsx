...
const JOURNEY_INFO = [
    {
        ...
        answer:
            "BNB Chain, Ethereum and BASE are the only options with on-chain execution, which means real swaps with real tokens and real value. Solana currently run as paper trading only, so it simulates portfolio performance without sending live transactions.",
    },
    {
