    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <motion.div
                ...
                className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden border border-white/60"
            >
                {/* Header */}
                        ...
                        <>
                            ...
                            <div className="flex gap-2 mb-6">
                                <button
                                    ...
                                    className={`flex-1 px-6 py-3 rounded-xl font-semibold transition-all ${currentTab === "available"
                                            ? "bg-black text-white"
                                ...
                                <button
                                    ...
                                    className={`flex-1 px-6 py-3 rounded-xl font-semibold transition-all ${currentTab === "completed"
                                            ? "bg-black text-white"
                                            : "bg-gray-200 text-gray-700 hover:bg-gray-300"
                                        }`}
                                >
